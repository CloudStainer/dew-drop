    ...
    650: function (e, t, r) {
      ...
      (t.addLocale = function (e) {
        for (
          ...
          a[o - 1] = arguments[o];
        return n.normalizePathTrailingSlash(r(8920).addLocale(e, ...a));
      }),
        ("function" == typeof t.default ||
          ("object" == typeof t.default && null !== t.default)) &&
          void 0 === t.default.__esModule &&
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        (t.detectDomainLocale = function () {
          for (var e = arguments.length, t = Array(e), n = 0; n < e; n++)
            t[n] = arguments[n];
          return r(6341).detectDomainLocale(...t);
        }),
        ("function" == typeof t.default ||
          ("object" == typeof t.default && null !== t.default)) &&
          void 0 === t.default.__esModule &&
    ...
    1911: function (e, t, r) {
      ...
      function V() {
        return (V = g(function* () {
          ...
          {
            let { normalizeLocalePath: e } = r(9303),
              { detectDomainLocale: t } = r(6341),
              { parseRelativeUrl: n } = r(6080),
              { formatUrl: l } = r(7535);
            if (a.locales) {
              let r = n(o),
          ...
          l
            ...
            .then((r) => {
              ...
              return Promise.resolve(
                ...
                eo(y({}, e, { err: i, Component: s, styleSheets: u, props: t }))
              );
            })
        );
      }
      ...
      class K {
        ...
        change(e, t, r, o, l) {
          ...
          return n(function* () {
            ...
            let q, Z;
            if (!M.isLocalURL(t)) return Y({ url: t, router: d }), !1;
            let G = 1 === o._h;
            G || o.shallow || (yield d._bfl(r, void 0, o.locale));
            let V =
                G ||
            ...
            d.isReady = !0;
            let J = d.isSsr;
            if ((G || (d.isSsr = !1), G && d.clc)) return !1;
            let Q = X.locale;
            {
              (X.locale =
              ...
              (null == (p = d.locales) ? void 0 : p.includes(X.locale)) ||
                ...
                Y({ url: _.formatWithValidation(e), router: d }),
                (a = !0));
            ...
            if (null == (n = d.components[el]) ? void 0 : n.__appRouter)
              return Y({ url: r, router: d }), new Promise(() => {});
            try {
            ...
            G || K.events.emit("routeChangeStart", r, er);
            ...
            try {
              let n = yield d.getRouteInfo({
                ...
                isQueryUpdating: G && !d.isFallback,
              ...
              if ("type" in n) {
                ...
                return (
                  Y({ url: n.destination, router: d }), new Promise(() => {})
                );
              }
              let i = n.Component;
              ...
              if ((n.__N_SSG || n.__N_SSP) && n.props) {
                if (n.props.pageProps && n.props.pageProps.__N_REDIRECT) {
                  ...
                  return Y({ url: t, router: d }), new Promise(() => {});
                }
                if (
              ...
              let P = G && !h && !$ && !ea && L.compareRouterStates(_, d.state);
              if (!P) {
                try {
                  yield d.set(_, n, h);
                } catch (e) {
                ...
                if (n.error)
                  throw (
                    (G || K.events.emit("routeChangeError", n.error, en, er),
                    n.error)
                  );
                X.locale && (document.documentElement.lang = X.locale),
                  G || K.events.emit("routeChangeComplete", r, er),
        ...
        getRouteInfo(e) {
          ...
          return n(function* () {
            ...
            try {
              ...
              if (C.isAPIRoute(e))
                return Y({ url: l, router: P }), new Promise(() => {});
              let L =
                  j ||
